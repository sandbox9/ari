...
public class LoginController extends BroadleafLoginController {
	...
	private static String loginView = "ari/authentication/login";

	@Override
	@RequestMapping("/login")
	public String login(HttpServletRequest request, HttpServletResponse response, Model model) {
		super.login(request, response, model);
		return getLoginView();
	}
	...
	public String processResetPassword(@ModelAttribute("resetPasswordForm") ResetPasswordForm resetPasswordForm, HttpServletRequest request,
